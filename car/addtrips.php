...
if($errors !== ''){
    ...
    $sql2 = "select phonenumber from users where user_id='".$_SESSION['user_id']."'";
    
    $cont = mysqli_query($link, $sql2);
    ...
    if($regular == "Y"){
        ...
        $sql = "INSERT INTO $tbl_name (`user_id`,`departure`, `destination`,  `price`, `seatsavailable`, `regular`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`, `time`,`contact`) VALUES ('".$_SESSION['user_id']."', '$departure','$destination','$price','$seatsavailable','$regular','$monday','$tuesday','$wednesday','$thursday','$friday','$saturday','$sunday','$time','$contact')";
        ...
        $sql = "INSERT INTO $tbl_name (`user_id`,`departure`, `destination`, `price`, `seatsavailable`, `regular`, `date`, `time`, `contact`) VALUES ('".$_SESSION['user_id']."', '$departure','$destination','$price','$seatsavailable','$regular','$date','$time','$contact')";   
    ...
    if($results){
        ...
        echo '<div class=" alert alert-danger">There was an error! The trip could not be added to database!</div>'.mysqli_error($link);        
    }
}
