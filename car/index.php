...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCwJ2Vepe9L2Miuh7QH87SR_RItIXHlX6Q"></script>
      <style>
  ...
  <body>
      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  ...
                  <p class="lead">Save Money! Save the Environment! By Sharing</p>
                  <p class="bold">You can save alot by sharing the car!
                  </p>
                  <!--Search Form-->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                  Sign up today and Start using our Web Services! 
    ...
    <!--Forgot password form-->
      ...
      <!-- All trips in the database -->
      
    <?php
      include('showalltrips.php');
