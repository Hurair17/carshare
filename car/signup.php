...
$subject = '<a href="http://localhost/project/CarShare/activate.php"></a>';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// $sub = 'Confirm your Registration';
// $message .= "http://carsharingwebsitefinal.thecompletewebhosting.com/activate.php?email=" . urlencode($email) . "&key=$activationKey";
// if(mail($email,$subject , $message, 'From:'.'developmentisland@gmail.com')){
